...
void main()
{
	GLFWwindow* window = initOpenGlWithSizeAndTitle(800, 600, "Shaders exercise 1");
	...
	strcat_s(vertexShaderPath, "/shaders_exercise_1.vert");

	char fragmentShaderPath[256];
	strcpy_s(fragmentShaderPath, shaderPath);
	strcat_s(fragmentShaderPath, "/shaders_exercise_1.frag");
