...
void main()
{
	GLFWwindow* window = initOpenGlWithSizeAndTitle(800, 600, "Shaders exercise 3");
	...
	strcat_s(vertexShaderPath, "/shaders_exercise_3.vert");

	char fragmentShaderPath[256];
	strcpy_s(fragmentShaderPath, shaderPath);
	strcat_s(fragmentShaderPath, "/shaders_exercise_3.frag");
